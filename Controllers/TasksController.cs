...
namespace EastViewAPI.Controllers
{
    ...
    public class TasksController : ControllerBase
    {
        ...
        public TasksController(DB context)
        {
            _context = context;
        }
        ...
        // GET: api/Tasks/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Entities.Task>> GetTask(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutTask(long id, Entities.Task task)
        {
            if (id != task.Id)
            {
                return BadRequest();
